...
export const ROSTER: RosterClient[] = [
  { id: 'c1', name: 'Timothy', goal: 'Fat loss', weightDelta: -3.8, adherence: 92, lastActive: '2h ago', next: 'Today · 9am', unread: 1, mode: 'online' },
  { id: 'c2', name: 'Jordan P.', goal: 'Build muscle', weightDelta: 2.1, adherence: 74, lastActive: '1d ago', next: 'Wed · 5pm', unread: 0, mode: 'inperson' },
