...
/** Days that are folded shut, keyed by their index in the day list. */
export type FoldedDays = Record<number, boolean>;
 ...
 */
export function foldsAfterRemoval(folds: FoldedDays, removed: number): FoldedDays {
  const next: FoldedDays = {};
