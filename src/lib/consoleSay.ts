...
/** A sentence a form has just said, and whether it is reporting a failure. */
export type Said = { text: string; bad: boolean } | null;

/** Something happened and this says what. Announced politely. */
export function wrote(text: string): Said {
 ...
 */
export function refused(text: string | null | undefined, fallback?: string): Said {
...
export function sayText(s: Said): string | null {
 ...
 */
export function sayTone(s: Said): 'crit' | undefined {
