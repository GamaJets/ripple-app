...
export const MIN_DIAL_DIGITS = 7;
export const MAX_DIAL_DIGITS = 15;
...
export function telUrl(raw: string | null | undefined): string | null {
  ...
  if (digits.length < MIN_DIAL_DIGITS || digits.length > MAX_DIAL_DIGITS) return null;
...
export const isDialable = (raw: string | null | undefined): boolean => telUrl(raw) != null;
