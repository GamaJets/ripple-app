...
// body-fat, muscle, charts, and meal targets across every screen.
...
interface Value {
  ...
  goal: Goal; diet: Diet; activity: number; mealsPerDay: 3 | 4 | 5;
...
export function ClientDataProvider({ children }: { children: ReactNode }) {
  ...
  const value: Value = {
    ...
    dob, setDob, heightCm, setHeightCm, goal: base.goal, diet: base.diet, activity: base.activity, mealsPerDay: base.mealsPerDay as 3 | 4 | 5,
