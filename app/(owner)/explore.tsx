...
// (`src/theme/scale`). No hero: a search screen has no live number to lead
// with — the field is the point, so it sits directly under the title and every
// result is a `<ListRow>` instead of a hand-rolled row inside one big box.
// Routes still come only from OWNER_NAV; nothing is hardcoded here.
