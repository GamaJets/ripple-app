...
// the owner reads and can hide from but does not post to, and the gym's
// upcoming events, which the owner creates for members or for coaches. Feed and queue are
// src/ui/CommunityFeed.tsx; who may read and hide what is part 3300.
import { useCallback, useState } from 'react';
import { ScrollView } from 'react-native';
import { SafeAreaView } from 'react-native-safe-area-context';
import { useTheme } from '../../src/ui/components';
import { PageHead, Section, SectionHead, Segmented } from '../../src/ui/kit';
