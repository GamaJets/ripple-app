// Role chooser / entry. In production this is the post-login router.
...
function Portal({ t, icon, title, sub, onPress }: { t: Theme; icon: string; title: string; sub: string; onPress: () => void }) {
  return (
    <Pressable onPress={onPress} style={{ backgroundColor: t.surface, borderColor: t.ring, borderWidth: 1, borderRadius: 18, padding: 18, marginBottom: 12, flexDirection: 'row', alignItems: 'center', gap: 14 }}>
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: t.bg }}>
      <ScrollView contentContainerStyle={{ padding: 22, paddingTop: 60 }}>
        ...
        <Text style={{ color: t.ink3, fontSize: 14, marginBottom: 30 }}>Preview build · running on demo data</Text>
