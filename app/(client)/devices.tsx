...
export default function Devices() {
  ...
  const DETAILS: Record<MetricKey, { ico: string; title: string; value: string; blurb: string }> = {
    ...
    hr: { ico: '❤️', title: 'Average Heart Rate', value: `${num(w.today.heartRateAvg)} bpm`, blurb: 'The mean of today’s heart-rate samples from your watch. During a workout, live heart rate is written into that session.' },
        ...
        {showLive ? (
          <View style={{ backgroundColor: t.surface, borderRadius: 20, borderWidth: 1, borderColor: t.ring, padding: 18, marginBottom: 16 }}>
            ...
            <View style={{ flexDirection: 'row', gap: 10, marginBottom: 10 }}>
              ...
              <Metric t={t} ico="❤️" label="Avg Heart Rate" value={num(w.today.heartRateAvg)} unit="bpm" onPress={() => setDetail('hr')} />
            </View>
