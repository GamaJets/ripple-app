...
const NETWORKS = [
  { id: 'instagram', name: 'Instagram', ico: '📷', note: 'Share to your Story or feed' },
  { id: 'tiktok', name: 'TikTok', ico: '🎵', note: 'Post progress clips' },
  { id: 'facebook', name: 'Facebook', ico: '👥', note: 'Share to timeline' },
  { id: 'x', name: 'X', ico: '✖️', note: 'Post an update' },
];
