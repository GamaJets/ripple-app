...
exports.NO_ZONE_LIST_NOTE = exports.ZONE_RESULT_LIMIT = void 0;
exports.pickableZones = pickableZones;
exports.zoneChoice = zoneChoice;
 ...
 */
function searchZones(all, query, limit = exports.ZONE_RESULT_LIMIT) {
    const q = fold(query);
    if (!q)
        return [];
    const banded = [];
 ...
 * its zone correctly.
 */
exports.NO_ZONE_LIST_NOTE = 'This phone cannot list the world’s timezones, so there is nothing to search. Type the IANA name instead — Europe/London, Asia/Dubai, America/Los_Angeles — and it is checked before it is saved.';
