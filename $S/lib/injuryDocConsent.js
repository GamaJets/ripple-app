...
exports.ADD_IT_MYSELF_LABEL = exports.RECORD_FAILED_NOTE = exports.RECORD_FAILED_TITLE = exports.REFUSED_NOTE = exports.REFUSED_TITLE = exports.SCREEN_PROMISE = exports.CONSENT_CANCEL_A11Y = exports.CONSENT_KEEP_A11Y = exports.CONSENT_SEND_A11Y = exports.CONSENT_CANCEL_LABEL = exports.CONSENT_KEEP_LABEL = exports.CONSENT_SEND_LABEL = exports.CONSENT_IF_YOU_DECLINE = exports.CONSENT_RETENTION = exports.CONSENT_WHAT = exports.CONSENT_WHO = exports.CONSENT_TITLE = exports.OCR_ENDPOINT = exports.OCR_VENDOR = void 0;
exports.maySendToOcr = maySendToOcr;
exports.docSendLine = docSendLine;
exports.docSendState = docSendState;
/* ── who it goes to ─────────────────────────────────────────────────────── */
/** Named, because "a third-party service" is not a name. */
exports.OCR_VENDOR = 'OCR.space';
...
exports.OCR_ENDPOINT = 'https://api.ocr.space/parse/image';
...
function maySendToOcr(answer) {
    return answer === 'granted';
}
/* ── what the member is asked ───────────────────────────────────────────── */
exports.CONSENT_TITLE = 'Send this document to be read?';
/** WHO. Named, and named as being outside this app and this gym. */
exports.CONSENT_WHO = `To read your document the app sends it to ${exports.OCR_VENDOR}, a text-recognition company. They are not part of this app and not part of your gym.`;
/** WHAT. The whole page, and what a page of a clinical document has on it. */
exports.CONSENT_WHAT = 'What goes is the whole document — every page of it, as a picture, not just the words about your injury. That picture carries your name, your clinician and anything else printed on the page.';
...
exports.CONSENT_RETENTION = `Once a copy has left, what ${exports.OCR_VENDOR} does with it is theirs, not ours, and we do not ask them to delete it.`;
/** What happens on no — a real route, stated before the choice rather than
 *  discovered after it. */
exports.CONSENT_IF_YOU_DECLINE = 'If you say no, the document is still saved privately in your account and nothing is sent anywhere. You then type the injury in yourself, and it counts exactly the same as one we had read.';
exports.CONSENT_SEND_LABEL = 'Send It to Be Read';
exports.CONSENT_KEEP_LABEL = 'Keep It Private';
exports.CONSENT_CANCEL_LABEL = 'Cancel';
...
exports.CONSENT_SEND_A11Y = `Send this document to ${exports.OCR_VENDOR} to be read`;
exports.CONSENT_KEEP_A11Y = `Save this document to my account and do not send it to ${exports.OCR_VENDOR}`;
exports.CONSENT_CANCEL_A11Y = 'Do not add this document at all';
/**
 ...
 */
exports.SCREEN_PROMISE = `Your coach never sees the file — only the injury you confirm. Reading a document means sending a copy of it to ${exports.OCR_VENDOR}, a company outside this app, and we ask you about that every time before anything leaves. Say no and it is saved to your account and sent nowhere.`;
/**
 ...
 */
function docSendLine(state) {
    switch (state) {
        case 'granted':
            return `A copy of this document was sent to ${exports.OCR_VENDOR} to be read, with your permission.`;
        case 'refused':
            return `You kept this one private. No part of it was sent to ${exports.OCR_VENDOR}.`;
        case 'no-record':
            return `We have no record either way for this document, so we cannot tell you whether it was sent to ${exports.OCR_VENDOR}.`;
        default:
 ...
 */
function docSendState(status, decision) {
...
exports.REFUSED_TITLE = 'Saved, and sent nowhere';
exports.REFUSED_NOTE = `This document is in your account and nothing about it went to ${exports.OCR_VENDOR}. Nobody read it, so there is nothing to suggest — add the injury in your own words and it works exactly the same.`;
/**
 ...
 * account.
 */
exports.RECORD_FAILED_TITLE = 'We did not send it';
exports.RECORD_FAILED_NOTE = 'Your document is saved, and it has not been sent anywhere. We could not write down that you agreed to it being read, and we will not send a medical document on an agreement we cannot show you afterwards. Try again in a moment, or add the injury yourself.';
/** The one route that is always open, whatever went wrong above. */
exports.ADD_IT_MYSELF_LABEL = 'Add It Myself';
