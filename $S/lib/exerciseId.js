...
exports.exerciseSlug = exerciseSlug;
exports.sameExercise = sameExercise;
exports.findExercise = findExercise;
exports.videoForExercise = videoForExercise;
exports.isAcademyClip = isAcademyClip;
/**
 ...
 */
function findExercise(name, catalogue) {
 ...
 */
function videoForExercise(exerciseName, videos, preferTrainerId) {
