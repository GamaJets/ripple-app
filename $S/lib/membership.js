...
exports.MEMBER_NO_CHANGED_NOTE = void 0;
exports.memberPrefix = memberPrefix;
exports.memberNoFrom = memberNoFrom;
 ...
 * than a generic one.
 */
function memberPrefix(brandLabel) {
 ...
 * one.
 */
function memberNoFrom(name, id, brandLabel) {
 ...
 */
exports.MEMBER_NO_CHANGED_NOTE = 'This number changed in a recent update, because the old one was short enough '
