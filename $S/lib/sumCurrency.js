...
exports.MIXED_CURRENCY_NOTE = void 0;
exports.totalMoney = totalMoney;
exports.emptyTotalMoney = emptyTotalMoney;
 ...
 */
function totalMoney(total, stated, gym) {
    const g = code(gym);
    if (total == null)
        return { currency: g, gap: 'no_total' };
    const s = code(stated);
    if (s)
        return { currency: s, gap: 'ok' };
 ...
 */
exports.MIXED_CURRENCY_NOTE = 'The rows behind this figure are not all in one currency, so there is no '
