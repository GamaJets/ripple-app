...
exports.unitsForRegion = unitsForRegion;
exports.resolveUnits = resolveUnits;
exports.deviceUnitNote = deviceUnitNote;
exports.deviceRegion = deviceRegion;
/**
 ...
 */
function unitsForRegion(region) {
 ...
 */
function resolveUnits(weightChosen, lengthChosen, region) {
 ...
 */
function deviceUnitNote(unit, source) {
    if (source === 'chosen')
        return null;
