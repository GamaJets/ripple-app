...
exports.EVAL_DEMO_BASE = exports.DEMO_BUCKET = exports.FRAME_MS = exports.FRAMES_ARE_UNHOSTED = exports.REPDB_FRAME_BASE = exports.FRAME_BASE = void 0;
exports.frameUrls = frameUrls;
exports.demoCaption = demoCaption;
exports.demoIsShippable = demoIsShippable;
exports.evalAnimationUrl = evalAnimationUrl;
...
exports.FRAME_BASE = 'https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises';
/**
 ...
 */
exports.REPDB_FRAME_BASE = 'https://cdn.jsdelivr.net/npm/@repdb/exercises@2026.8.1';
 ...
 * everywhere at once.
 */
exports.FRAMES_ARE_UNHOSTED = false;
/**
 ...
 */
function frameUrls(paths, source) {
    ...
    const base = repdb ? exports.REPDB_FRAME_BASE : exports.FRAME_BASE;
    const shape = repdb
...
function demoCaption(source, frames) {
    if (frames <= 0)
        return null;
    if (source === 'repdb')
        return 'Illustration — start and peak position.';
    if (source === 'free-exercise-db')
        return 'Reference illustration — start and end position.';
    return null;
}
...
exports.DEMO_BUCKET = 'exercise-demos';
/**
 ...
 */
function demoIsShippable(licence, isRelease) {
 ...
 */
exports.EVAL_DEMO_BASE = 'http://localhost:8899';
/**
 ...
 */
function evalAnimationUrl(animationPath, licence) {
    ...
    // than an honest gap.
    if (!/^[\w-]+\.(webp|gif|mp4|webm)$/i.test(clean))
        return null;
    return `${exports.EVAL_DEMO_BASE}/${clean}`;
}
