...
exports.FAT_G_PER_KG_BODYWEIGHT = exports.PROTEIN_G_PER_KG_LEAN = void 0;
exports.liftingMacros = liftingMacros;
exports.rangeLabel = rangeLabel;
/** g of protein per kg of LEAN mass per day. The table's own range. */
exports.PROTEIN_G_PER_KG_LEAN = { low: 1.8, high: 2.2 };
/** g of fat per kg of TOTAL bodyweight per day. The table's own range. */
exports.FAT_G_PER_KG_BODYWEIGHT = { low: 0.8, high: 1.0 };
 ...
 */
function liftingMacros(weightKg, bodyFatPct, mealsPerDay) {
    ...
    if (!inRange(weightKg, 0, 400))
        return null;
    if (!inRange(bodyFatPct, -1, 100))
        return null;
    const leanKg = weightKg * (1 - bodyFatPct / 100);
    const protein = {
        low: Math.round(leanKg * exports.PROTEIN_G_PER_KG_LEAN.low),
        high: Math.round(leanKg * exports.PROTEIN_G_PER_KG_LEAN.high),
    };
    const fat = {
        low: Math.round(weightKg * exports.FAT_G_PER_KG_BODYWEIGHT.low),
        high: Math.round(weightKg * exports.FAT_G_PER_KG_BODYWEIGHT.high),
    };
