...
exports.UPCOMING_GRACE_MS = void 0;
exports.upcomingFrom = upcomingFrom;
 ...
 */
exports.UPCOMING_GRACE_MS = 3600000;
/** The instant at or after which a session still counts as ahead of you. */
function upcomingFrom(now) {
    return now - exports.UPCOMING_GRACE_MS;
}
/**
 ...
 */
function hasStarted(startsAt, now) {
    const t = Date.parse(String(startsAt ?? ''));
    if (Number.isNaN(t))
        return false;
    return t <= now;
