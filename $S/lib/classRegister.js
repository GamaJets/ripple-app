 ...
 */
function registerLine(c, known) {
    if (!known)
        return 'The roster could not be read — this is not a count of zero.';
    ...
    if (c.missing === 0)
        return `Everyone booked is here.${walk}`;
