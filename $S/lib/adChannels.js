...
exports.NO_TOTAL_NOTE = exports.AD_CHANNELS = void 0;
exports.isAdChannel = isAdChannel;
exports.channelLabel = channelLabel;
exports.channelPlaces = channelPlaces;
exports.majorFromMicros = majorFromMicros;
exports.combineChannelSpend = combineChannelSpend;
exports.channelList = channelList;
exports.combineRefusalNote = combineRefusalNote;
exports.channelStateNote = channelStateNote;
exports.coverageNote = coverageNote;
exports.channelSetupNote = channelSetupNote;
/** The channels a coach can connect. Order is the order they are shown in. */
exports.AD_CHANNELS = ['meta', 'google', 'tiktok'];
...
function isAdChannel(v) {
    return typeof v === 'string' && exports.AD_CHANNELS.includes(v);
}
 ...
 */
function combineChannelSpend(runs) {
    ...
    const codes = [...totals.values()]
        ...
        parts: c.parts.sort((a, b) => exports.AD_CHANNELS.indexOf(a.channel) - exports.AD_CHANNELS.indexOf(b.channel)),
    }))
...
function channelStateNote(c, state) {
 ...
 */
exports.NO_TOTAL_NOTE = 'There is no combined figure while a channel is unread, because a total that quietly leaves one out is a smaller number that looks exactly like a real one. The channels that did answer are listed with what each of them reported, and those figures are real.';
/**
 * Said wherever the combined figure IS shown, because "your ad spend" means
 * the accounts the coach linked and nothing else.
 */
function coverageNote(channels) {
    if (!channels.length)
        return 'No ad account is connected, so this covers nothing that was spent on ads.';
