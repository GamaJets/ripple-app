...
exports.SCAN_TYPE_IT_MYSELF_LABEL = exports.SCAN_RECORD_FAILED_NOTE = exports.SCAN_RECORD_FAILED_TITLE = exports.SCAN_REFUSED_NOTE = exports.SCAN_REFUSED_TITLE = exports.SCAN_CONSENT_CANCEL_A11Y = exports.SCAN_CONSENT_TYPE_A11Y = exports.SCAN_CONSENT_CANCEL_LABEL = exports.SCAN_CONSENT_TYPE_LABEL = exports.SCAN_CONSENT_SEND_LABEL = exports.SCAN_CONSENT_IF_YOU_DECLINE = exports.SCAN_CONSENT_WHAT = exports.SCAN_CONSENT_TITLE = exports.SCAN_CONSENT_KICKER = exports.SCAN_OCR_RECIPIENT = exports.SCAN_VISION_RECIPIENT = void 0;
exports.scanSheetRecipients = scanSheetRecipients;
exports.recipientNames = recipientNames;
exports.maySendScanSheet = maySendScanSheet;
exports.scanConsentWho = scanConsentWho;
exports.scanConsentRetention = scanConsentRetention;
exports.scanConsentSendA11y = scanConsentSendA11y;
exports.scanScreenPromise = scanScreenPromise;
exports.sheetSendLine = sheetSendLine;
exports.sheetSendState = sheetSendState;
/** supabase/functions/vision-analyze/index.ts POSTs here. */
exports.SCAN_VISION_RECIPIENT = {
    vendor: 'Anthropic',
 ...
 * comparable.
 */
function scanSheetRecipients(visionOn) {
    return visionOn
        ? [exports.SCAN_VISION_RECIPIENT, exports.SCAN_OCR_RECIPIENT]
        : [exports.SCAN_OCR_RECIPIENT];
}
...
function maySendScanSheet(answer) {
    return answer === 'granted';
}
/* ── what the member is asked ───────────────────────────────────────────── */
exports.SCAN_CONSENT_KICKER = 'Before you photograph the sheet';
exports.SCAN_CONSENT_TITLE = 'Send this printout to be read?';
/** WHO. Named, named as outside this app and this gym, and only the ones that
 *  are actually going to get it in this build. */
function scanConsentWho(rs) {
...
exports.SCAN_CONSENT_WHAT = 'What goes is the whole sheet, as a picture — not just the three figures this screen keeps. That picture carries whatever the machine printed: your name, your age or date of birth, your height, the gym or clinic at the top, the date you stood on it, and every line of the breakdown down the side.';
...
function scanConsentRetention(rs) {
...
exports.SCAN_CONSENT_IF_YOU_DECLINE = 'If you say no, nothing is sent anywhere. You type the weight, body fat and muscle off the sheet yourself — it is three numbers, they go in exactly the same, and the scan counts exactly the same as one we had read.';
exports.SCAN_CONSENT_SEND_LABEL = 'Send It to Be Read';
exports.SCAN_CONSENT_TYPE_LABEL = 'I’ll Type the Numbers';
exports.SCAN_CONSENT_CANCEL_LABEL = 'Cancel';
function scanConsentSendA11y(rs) {
    return `Send a photo of this sheet to ${recipientNames(rs)} to be read`;
}
exports.SCAN_CONSENT_TYPE_A11Y = 'Do not send anything — type the numbers off the sheet myself';
exports.SCAN_CONSENT_CANCEL_A11Y = 'Do not photograph the sheet at all';
...
exports.SCAN_REFUSED_TITLE = 'Sent nowhere';
exports.SCAN_REFUSED_NOTE = 'Nothing about your sheet left this phone, so there is nothing to fill the boxes in with. Type the weight, body fat and muscle off the printout and save it — it counts exactly the same.';
/**
 ...
 */
exports.SCAN_RECORD_FAILED_TITLE = 'We did not send it';
exports.SCAN_RECORD_FAILED_NOTE = 'Nothing has been sent anywhere. We could not write down that you agreed to your sheet being read, and we will not send a page with your name and your body composition on it on an agreement we cannot show you afterwards. Try again in a moment, or type the numbers in.';
/** The one route that is always open, whatever went wrong above. */
exports.SCAN_TYPE_IT_MYSELF_LABEL = 'Type the Numbers';
/**
 ...
 */
function sheetSendLine(state, vendors = []) {
 ...
 * under a failed read.
 */
function sheetSendState(status, decision) {
