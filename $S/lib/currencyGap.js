...
exports.currencyGapOf = currencyGapOf;
exports.currencyGapOfStatus = currencyGapOfStatus;
exports.currencyGapLine = currencyGapLine;
exports.currencyGapLineAbout = currencyGapLineAbout;
/**
 ...
 */
function currencyGapOfStatus(input) {
    if (input.currency)
        return null;
 ...
 */
function currencyGapLine(gap, consequence) {
 ...
 * to ask the coach.
 */
function currencyGapLineAbout(gap, who) {
    const w = who.trim();
    switch (gap) {
        case 'reading':
