...
exports.LARGE_TYPE_SCALE = exports.MAX_FONT_SCALE = exports.MIN_FONT_SCALE = void 0;
exports.clampFontScale = clampFontScale;
exports.atScale = atScale;
exports.isLargeTypeScale = isLargeTypeScale;
exports.effectiveWidth = effectiveWidth;
exports.linesAtScale = linesAtScale;
exports.fontScaleNote = fontScaleNote;
/**
 ...
 */
exports.MIN_FONT_SCALE = 0.8;
exports.MAX_FONT_SCALE = 4;
 ...
 */
function clampFontScale(raw) {
    if (typeof raw !== 'number' || !Number.isFinite(raw) || raw <= 0)
        return 1;
    return Math.min(exports.MAX_FONT_SCALE, Math.max(exports.MIN_FONT_SCALE, raw));
}
/**
...
function isLargeTypeScale(scale) {
    return clampFontScale(scale) >= exports.LARGE_TYPE_SCALE;
}
/**
 ...
 */
function effectiveWidth(widthPt, scale) {
 ...
 */
function linesAtScale(scale, base = 1) {
