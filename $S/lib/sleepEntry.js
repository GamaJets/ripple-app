...
exports.MAX_QUALITY = exports.MAX_SLEEP_HOURS = void 0;
exports.isFilableNight = isFilableNight;
exports.sleepRefusal = sleepRefusal;
exports.MAX_SLEEP_HOURS = 24;
...
function isFilableNight(hours, quality) {
    return Number.isFinite(hours) && hours > 0 && hours <= exports.MAX_SLEEP_HOURS
        && Number.isInteger(quality) && quality >= 1 && quality <= exports.MAX_QUALITY;
}
/**
 ...
 */
function sleepRefusal(hours, quality) {
    if (isFilableNight(hours, quality))
        return null;
    if (!Number.isFinite(hours) || hours <= 0)
        return 'How many hours did you sleep? Type the hours.';
    if (hours > exports.MAX_SLEEP_HOURS) {
        return `A night is at most ${exports.MAX_SLEEP_HOURS} hours, so ${hours} could not be stored and nothing has been logged. If you meant ${hours / 10}, type that.`;
    }
    return `Mark how well you slept, from 1 to ${exports.MAX_QUALITY}, and it will be logged.`;
}
