 ...
 */
function liftFor({ barY, barHeight, applied, keyboardScreenY }) {
    ...
    if (![barY, barHeight, applied, keyboardScreenY].every((n) => typeof n === 'number' && isFinite(n)))
        return null;
    if (barHeight <= 0)
        return null;
