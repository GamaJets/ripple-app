...
exports.UNKNOWN_LOAD = void 0;
exports.bestSetLabel = bestSetLabel;
 ...
 */
function bestSetLabel(pr, loadLabel, addedLabel, voice = 'screen') {
    ...
    if (reps == null)
        return voice === 'spoken' ? 'an unrecorded set' : exports.UNKNOWN_LOAD;
    if (pr.bodyweight) {
        ...
        return (0, bodyweightSets_1.bodyweightSetLabel)(reps, pr.addedKg ?? 0, addedLabel);
    }
    if (loadLabel == null) {
        ...
        return voice === 'spoken' ? `${reps} reps` : `${exports.UNKNOWN_LOAD} × ${reps}`;
    }
