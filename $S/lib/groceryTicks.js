...
exports.isGroceryTicksKey = exports.GROCERY_TICKS_PREFIX = void 0;
exports.groceryTicksKey = groceryTicksKey;
exports.readGroceryTicks = readGroceryTicks;
...
exports.GROCERY_TICKS_PREFIX = 'repple.grocery.checked:';
/**
 ...
 */
function groceryTicksKey(uid, weekKey) {
    ...
    if (!id || id === 'unknown' || !wk)
        return null;
    return `${exports.GROCERY_TICKS_PREFIX}${id}:${wk}`;
}
/** Whether a key holds somebody's grocery ticks. For the sign-out assertion. */
const isGroceryTicksKey = (k) => typeof k === 'string' && k.startsWith(exports.GROCERY_TICKS_PREFIX);
exports.isGroceryTicksKey = isGroceryTicksKey;
/**
