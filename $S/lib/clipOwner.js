...
exports.clipOwner = clipOwner;
exports.canManageClip = canManageClip;
exports.canRemoveClip = canRemoveClip;
/**
 ...
 */
function clipOwner(clip, myId) {
    if (!clip.id.startsWith('db'))
        return 'local';
    if (clip.trainerId === null)
        return 'platform';
    if (myId && clip.trainerId === myId)
        return 'mine';
    return 'other';
}
/**
 ...
 */
function canManageClip(clip, myId) {
 ...
 */
function canRemoveClip(clip, myId) {
