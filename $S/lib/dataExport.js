...
exports.COACH_DELETION_FILES_NOTE = exports.DELETION_FILES_NOTE = exports.EXPORT_ROW_NOTE = void 0;
exports.fileSizeLabel = fileSizeLabel;
exports.filesRowNote = filesRowNote;
exports.saveFileFailure = saveFileFailure;
exports.coachDataFilename = coachDataFilename;
exports.incompleteExportLine = incompleteExportLine;
...
function saveFileFailure(blocker) {
    return blocker
 ...
 */
exports.EXPORT_ROW_NOTE = 'Your records, your money, your bookings and a list of your files';
/**
 ...
 */
function coachDataFilename(brandId) {
 ...
 * harm them.
 */
exports.DELETION_FILES_NOTE = 'Your records are deleted with your account. The files behind them go separately, on a queue: your progress '
 ...
 */
exports.COACH_DELETION_FILES_NOTE = 'Your records are deleted with your account. The files behind them go separately, on a queue: your logo, any '
 ...
 *  are in the file. */
function incompleteExportLine(parts, supportEmail) {
