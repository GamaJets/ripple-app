...
exports.parseDismissed = parseDismissed;
exports.sameIds = sameIds;
exports.nextDismissed = nextDismissed;
exports.withDismissed = withDismissed;
exports.packDismissed = packDismissed;
/**
 ...
 * already had.
 */
function nextDismissed(prev, next) {
 ...
 */
function withDismissed(prev, id) {
    if (!id || prev.has(id))
        return prev;
