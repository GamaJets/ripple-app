...
const tablePage_1 = require("./tablePage");
const errors = [];
 ...
 */
{
    const wide = (0, tablePage_1.tableWindow)(3000, 200, 4);
    ...
    const narrow = (0, tablePage_1.tableWindow)(30, 200, 4);
 ...
 */
{
    const last = (0, tablePage_1.tableWindow)(214, 200, 1);
    ...
    const exact = (0, tablePage_1.tableWindow)(400, 200, 0);
    eq(exact.pages, 2, '400 rows at 200 a page is two pages, not three');
    eq((0, tablePage_1.tableWindow)(400, 200, 1).to, 399, 'and the second one ends on the last row');
    const one = (0, tablePage_1.tableWindow)(200, 200, 0);
    eq(one.pages, 1, 'a list that exactly fills one page is one page');
    eq(one.to, 199, 'and the window is the whole of it');
    const none = (0, tablePage_1.tableWindow)(0, 200, 0);
 ...
 */
{
    eq((0, tablePage_1.rowCountLine)((0, tablePage_1.tableWindow)(12, 200, 0), 12, 'members'), '12 members', 'one page states the count');
    eq((0, tablePage_1.rowCountLine)((0, tablePage_1.tableWindow)(3000, 200, 0), 3000, 'members'), '1–200 of 3000 members', 'the first page of many states where it is');
    eq((0, tablePage_1.rowCountLine)((0, tablePage_1.tableWindow)(3000, 200, 14), 3000, 'members'), '2801–3000 of 3000 members', 'the last page ends on the last row');
    eq((0, tablePage_1.rowCountLine)((0, tablePage_1.tableWindow)(0, 200, 0), 0, 'payments'), 'no payments', 'an empty list says so in words rather than printing a 0');
    eq((0, tablePage_1.rowCountLine)((0, tablePage_1.tableWindow)(1, 200, 0), 1, 'rows'), '1 rows', 'the noun is the caller’s to get right — this does not invent a plural');
    eq((0, tablePage_1.rowCountLine)((0, tablePage_1.tableWindow)(3000, 200, 0), 3000, 'members', (n) => n.toLocaleString('en-GB')), '1–200 of 3,000 members', 'the formatter is injected, so the separator is the reader’s locale and not this file’s');
}
/* ── DEGENERATE ───────────────────────────────────────────────────────────
 ...
 */
{
    const zero = (0, tablePage_1.tableWindow)(500, 0, 3);
