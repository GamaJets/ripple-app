...
exports.NOT_A_QUIET_GYM = void 0;
exports.noGymNote = noGymNote;
exports.gymLink = gymLink;
/**
 ...
 */
exports.NOT_A_QUIET_GYM = 'This is not a gym with nothing in it — it is an account with no gym on it. The owner sets that.';
/**
 ...
 * the screen for.
 */
function noGymNote(what) {
    const subject = (what || '').trim() || 'records';
    return `Your account is not linked to a gym, so there are no ${subject} to read. ${exports.NOT_A_QUIET_GYM}`;
}
/**
 ...
 */
function gymLink(tenantId, what) {
