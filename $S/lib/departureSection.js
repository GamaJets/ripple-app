...
exports.departureSectionNote = departureSectionNote;
 ...
 */
function departureSectionNote(tally, windowDays) {
    const base = (0, endCoaching_1.departureLine)(tally, windowDays);
    if (base == null || tally == null)
        return null;
