...
exports.matchesRosterQuery = matchesRosterQuery;
exports.searchRoster = searchRoster;
exports.rosterSearchLine = rosterSearchLine;
exports.rosterPickerLine = rosterPickerLine;
/**
 ...
 */
const terms = (s) => s.normalize('NFD').replace(/[\u0300-\u036f]/g, '').toLowerCase().split(/[^a-z0-9]+/).filter(Boolean);
/**
 ...
 */
const haystack = (name) => terms(name).join('');
/**
 ...
 */
function matchesRosterQuery(name, query) {
 ...
 */
function searchRoster(list, query) {
