...
exports.snapshotFee = snapshotFee;
exports.snapshotCurrency = snapshotCurrency;
exports.rateCentsToSnapshot = rateCentsToSnapshot;
 ...
 */
function snapshotFee(gymFee, ownFee) {
 ...
 */
function snapshotCurrency(gymCurrency, mine) {
 ...
 */
function rateCentsToSnapshot(s) {
    return (0, coachMoney_1.minorFromWhole)(snapshotFee(s.gymFee, s.ownFee), snapshotCurrency(s.gymCurrency, s.mine));
}
