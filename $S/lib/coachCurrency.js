...
exports.WHY_NOT_A_REPRICE = exports.CURRENCY_CHOICES = void 0;
exports.isCurrencyCode = isCurrencyCode;
exports.isMissingFunction = isMissingFunction;
exports.readSetCurrency = readSetCurrency;
exports.setCurrencyLine = setCurrencyLine;
exports.classifySetCurrencyError = classifySetCurrencyError;
exports.isMissingColumn = isMissingColumn;
exports.classifySetCoachCurrencyError = classifySetCoachCurrencyError;
 ...
 */
exports.WHY_NOT_A_REPRICE = 'Your currency is already set, so this does not change it. Every price you have stored is denominated in it, and changing it here would quietly reprice packages your clients are already paying for. Ask support to change it with your figures in front of you.';
 ...
 */
function readSetCurrency(reply) {
 ...
 */
function setCurrencyLine(outcome, code) {
    switch (outcome) {
        case 'set':
        ...
        case 'already-set':
            return exports.WHY_NOT_A_REPRICE;
        case 'bad-code':
 ...
 * listening".
 */
function classifySetCurrencyError(e) {
    if (!e)
        return 'refused';
    if (isMissingFunction(e))
        return 'unavailable';
    return (0, offlineQueue_1.classifyWrite)(e, 1) === 'refused' ? 'refused' : 'unsent';
}
/**
 ...
 */
function classifySetCoachCurrencyError(e) {
    if (!e)
        return 'refused';
    if (isMissingFunction(e))
        return 'no-column';
