...
exports.reconcileInBodyUnit = reconcileInBodyUnit;
exports.visionMassKg = visionMassKg;
 ...
 */
function reconcileInBodyUnit(args) {
    ...
    if (sheetUnit === 'lb') {
        if (visionWeight != null && sheetWeight != null) {
            if (near(visionWeight, sheetWeight)) {
                return { unit: 'lb', convert: true, note: inbodySheet_1.CONVERTED_FROM_LB_NOTE };
            }
            if (near(visionWeight, (0, units_1.lbToKg)(sheetWeight))) {
                ...
                return { unit: 'kg', convert: false, note: inbodySheet_1.CONVERTED_FROM_LB_NOTE };
            }
            // Two numbers that tell neither story. Something was misread and this
            // module will not pick a winner.
            return { unit: null, convert: false, note: inbodySheet_1.ASSUMED_METRIC_NOTE };
        }
...
function visionMassKg(value, verdict) {
    if (value == null || !Number.isFinite(value))
        return null;
    return verdict.convert ? (0, units_1.lbToKg)(value) : value;
}
