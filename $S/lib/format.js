...
exports.fmtRelativeDay = fmtRelativeDay;
exports.weekdayName = weekdayName;
exports.weekdayNameShort = weekdayNameShort;
exports.monthNames = monthNames;
exports.monthNamesShort = monthNamesShort;
exports.fmtFullDay = fmtFullDay;
exports.fmtTime = fmtTime;
exports.fmtClock = fmtClock;
exports.fmtAxisDay = fmtAxisDay;
exports.fmtAxisMonth = fmtAxisMonth;
exports.fmtPointDay = fmtPointDay;
exports.fmtPointMonth = fmtPointMonth;
exports.seriesDelta = seriesDelta;
exports.catalogueValue = catalogueValue;
exports.num = num;
exports.num1 = num1;
 ...
 */
function fmtRelativeDay(iso, now = new Date()) {
    const d = (0, localDate_1.localDate)(iso);
    if (!d)
        return '—';
...
function weekdayName(dow) {
    ...
    try {
        return new Intl.DateTimeFormat((0, locale_1.appLocale)(), { weekday: 'long', timeZone: 'UTC' })
...
function weekdayNameShort(dow) {
    const i = ((Math.trunc(dow) % 7) + 7) % 7;
    try {
        return new Intl.DateTimeFormat((0, locale_1.appLocale)(), { weekday: 'short', timeZone: 'UTC' })
            .format(new Date(Date.UTC(2024, 0, 7 + i)));
    }
    catch {
        return EN_DOW_SHORT[i];
    }
}
/**
...
function monthNames(locale = (0, locale_1.appLocale)()) {
    try {
...
function monthNamesShort(locale = (0, locale_1.appLocale)()) {
    try {
...
function fmtFullDay(iso) {
    ...
    if (!d)
        return '—';
    return d.toLocaleDateString((0, locale_1.appLocale)(), { day: 'numeric', month: 'short', year: 'numeric' });
}
...
function fmtClock(h, m) {
    ...
    try {
        const parts = new Intl.DateTimeFormat((0, locale_1.appLocale)(), { hour: 'numeric', minute: '2-digit' }).formatToParts(at);
...
function fmtAxisDay(y, m, day) {
    return new Date(y, m, day).toLocaleDateString((0, locale_1.appLocale)(), { day: 'numeric', month: 'short' });
}
...
function fmtAxisMonth(y, m) {
    return new Date(y, m, 1).toLocaleDateString((0, locale_1.appLocale)(), { month: 'short', year: '2-digit' });
}
/** Touch readout, day precision: "14 Aug 2026". The exact date that was asked for. */
function fmtPointDay(y, m, day) {
    return new Date(y, m, day).toLocaleDateString((0, locale_1.appLocale)(), { day: 'numeric', month: 'short', year: 'numeric' });
}
/** Touch readout, month precision: "Aug 2026". */
function fmtPointMonth(y, m) {
    return new Date(y, m, 1).toLocaleDateString((0, locale_1.appLocale)(), { month: 'short', year: 'numeric' });
}
...
function num(n) {
    if (n == null || !Number.isFinite(n))
        return '—';
    return Math.round(n).toLocaleString((0, locale_1.appLocale)());
}
...
function num1(n) {
    if (n == null || !Number.isFinite(n))
        return '—';
    return n.toLocaleString((0, locale_1.appLocale)(), { minimumFractionDigits: 1, maximumFractionDigits: 1 });
}
