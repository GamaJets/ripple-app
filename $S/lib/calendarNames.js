...
exports.weekdayNamesNarrow = exports.weekdayNamesShort = exports.monthNamesLong = void 0;
 ...
 */
const monthNamesLong = (locale = (0, locale_1.appLocale)()) => names('monthsLong', locale);
exports.monthNamesLong = monthNamesLong;
 ...
 *  locale's. */
const weekdayNamesShort = (locale = (0, locale_1.appLocale)()) => names('daysShort', locale);
exports.weekdayNamesShort = weekdayNamesShort;
/**
 ...
 */
const weekdayNamesNarrow = (locale = (0, locale_1.appLocale)()) => names('daysNarrow', locale);
exports.weekdayNamesNarrow = weekdayNamesNarrow;
