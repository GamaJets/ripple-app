...
exports.readSessionFee = readSessionFee;
exports.sessionFeeAmount = sessionFeeAmount;
exports.sessionFeeShort = sessionFeeShort;
exports.sessionFeeNote = sessionFeeNote;
/**
 ...
 * exists to remove.
 */
function sessionFeeNote(f, coachName) {
