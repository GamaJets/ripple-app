...
exports.PASSWORD_MIN = void 0;
exports.passwordRules = passwordRules;
exports.passwordMeetsLocalRules = passwordMeetsLocalRules;
exports.passwordRulesRemaining = passwordRulesRemaining;
exports.passwordErrorMessage = passwordErrorMessage;
...
function passwordRules(pw) {
    const p = pw || '';
    return [
        { label: `${exports.PASSWORD_MIN} characters or more`, met: p.length >= exports.PASSWORD_MIN },
 ...
 */
function passwordErrorMessage(raw) {
    ...
    if (m.includes('at least') && m.includes('characters')) {
        return `Passwords need to be at least ${exports.PASSWORD_MIN} characters.`;
    }
