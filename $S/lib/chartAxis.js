...
exports.looksIso = exports.DASH = void 0;
exports.readDate = readDate;
exports.axisLabel = axisLabel;
exports.pointLabel = pointLabel;
exports.tickIndices = tickIndices;
exports.maxTicksForWidth = maxTicksForWidth;
exports.readablePoints = readablePoints;
exports.segments = segments;
exports.hasInteriorGap = hasInteriorGap;
 ...
 */
const looksIso = (raw) => raw != null && /^\d{4}-\d{2}/.test(String(raw).trim());
exports.looksIso = looksIso;
/**
...
function axisLabel(raw) {
    if (raw == null || String(raw).trim() === '')
        return exports.DASH;
    const s = String(raw).trim();
    if (!(0, exports.looksIso)(s))
        return s;
    const p = readDate(s);
    if (!p)
        return exports.DASH;
    return p.day == null ? (0, format_1.fmtAxisMonth)(p.y, p.m) : (0, format_1.fmtAxisDay)(p.y, p.m, p.day);
}
/**
...
function pointLabel(raw) {
    ...
    if (!p)
        return exports.DASH;
    return p.day == null ? (0, format_1.fmtPointMonth)(p.y, p.m) : (0, format_1.fmtPointDay)(p.y, p.m, p.day);
}
/* ── laying out the axis ──────────────────────────────────────────────────── */
/**
 ...
 */
function tickIndices(count, maxTicks) {
    if (count <= 0)
        return [];
    if (count === 1)
        return [0];
 ...
 */
function maxTicksForWidth(width, perLabel = 54) {
