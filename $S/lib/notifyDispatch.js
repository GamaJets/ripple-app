...
exports.PUSHED_BY_ITS_WRITER = void 0;
exports.channelForRoute = channelForRoute;
exports.channelForTitle = channelForTitle;
exports.notificationChannel = notificationChannel;
exports.dispatchDecision = dispatchDecision;
/**
...
function channelForTitle(title) {
    const t = (title ?? '').trim();
    if (!t)
        return null;
 ...
 * database.
 */
function notificationChannel(route, title) {
 ...
 */
function dispatchDecision(route, title, pushedByCaller) {
    if (pushedByCaller) {
        return {
    ...
    const r = bareRoute(route);
    if (r && exports.PUSHED_BY_ITS_WRITER.includes(r)) {
        return {
            dispatch: false, channel: notificationChannel(route, title),
