...
exports.PORTIONS = exports.DISHES = exports.CUISINES = void 0;
exports.estimateDish = estimateDish;
exports.searchDishes = searchDishes;
exports.CUISINES = ['American', 'Italian', 'Mexican', 'Chinese', 'Japanese', 'Indian', 'Thai', 'Mediterranean', 'Cafe', 'Fast food'];
...
function estimateDish(dish, mult = 1) {
...
function searchDishes(query, limit = 40) {
    const q = (query || '').trim().toLowerCase();
    if (!q)
        return exports.DISHES.slice(0, limit);
    return exports.DISHES.filter((d) => d.name.toLowerCase().includes(q) || d.cuisine.toLowerCase().includes(q)).slice(0, limit);
}
