...
exports.startGate = startGate;
const OPEN = { canStart: true, reason: 'none', note: null, safety: false };
/**
...
function startGate(input) {
    ...
    if (!isStrength)
        return { canStart: false, reason: 'not-strength', note: null, safety: false };
    ...
    if (planned === 0)
        return { canStart: false, reason: 'rest-day', note: null, safety: false };
    if (runnable > 0)
        return OPEN;
