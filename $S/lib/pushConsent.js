...
exports.pushConsent = pushConsent;
exports.recordPushConsent = recordPushConsent;
/**
...
function pushConsent() { return current; }
/**
 ...
 */
function recordPushConsent(answer) { current = answer; }
