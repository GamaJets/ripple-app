...
exports.READ_DEADLINE_MS = void 0;
 ...
 */
exports.READ_DEADLINE_MS = requestTimeout_1.CALL_CEILING_MS * (0, requestTimeout_1.maxAttempts)('GET') + 5000;
/**
 ...
 */
function stalled(status, elapsedMs, ceilingMs = exports.READ_DEADLINE_MS) {
    if (status !== 'loading')
        return false;
 ...
 */
function escalate(status, hitCeiling) {
 ...
 */
function withDeadline(work, opts = {}) {
    const ms = opts.ms ?? exports.READ_DEADLINE_MS;
    ...
    if (!Number.isFinite(ms) || ms <= 0)
        return work.then((value) => ({ answered: true, value }));
