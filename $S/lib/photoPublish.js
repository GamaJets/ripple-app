...
exports.PUBLISH_IS_SEPARATE_NOTE = exports.PICK_A_CLIENT_FIRST = exports.SEEING_IS_NOT_PUBLISHING = void 0;
exports.mayPublishPhoto = mayPublishPhoto;
exports.publishConsentOf = publishConsentOf;
exports.publishablePhotos = publishablePhotos;
exports.publishConsentNote = publishConsentNote;
exports.publishAskTitle = publishAskTitle;
exports.publishAskBody = publishAskBody;
exports.withdrawPublishBody = withdrawPublishBody;
exports.publishStateOf = publishStateOf;
exports.publishLabel = publishLabel;
exports.publishBlocker = publishBlocker;
/**
 * THE gate. Nothing else in this app decides this.
 *
 * Only an explicit grant, read successfully, allows an image onto a card.
 */
function mayPublishPhoto(consent) {
 ...
 */
function publishConsentOf(photoId, coachId, grants, status) {
 ...
 */
function publishablePhotos(visible, coachId, grants, status) {
    if (!coachId || visible == null || grants == null)
        return null;
    if (status === 'loading' || status === 'error')
        return null;
 ...
 */
function publishConsentNote(consent) {
    switch (consent) {
        case 'granted':
            return null;
        case 'absent':
 ...
 */
exports.SEEING_IS_NOT_PUBLISHING = 'A photo your client sent you is for your coaching. Putting one in something you post in public is a separate thing to agree to, and only your client can agree to it.';
/** What a coach is told when they have picked nobody. Not an error: it is the
 *  first state of the screen. */
exports.PICK_A_CLIENT_FIRST = 'Choose the client this card is about and Repple will show the photos they have agreed you can publish. There will be none until they have.';
 ...
 */
function publishAskTitle(coachName) {
 ...
 */
function publishAskBody(coachName) {
...
function withdrawPublishBody(coachName) {
    const who = (coachName ?? '').trim() || 'your coach';
...
function publishStateOf(photoId, grants) {
    if (grants == null)
        return 'unknown';
 ...
 */
function publishBlocker(photoId, coach, shared) {
    if (!coach) {
...
exports.PUBLISH_IS_SEPARATE_NOTE = 'Sending a photo to your coach lets them look at it. It does not let them put it in anything they post in public. That is a separate thing you agree to per photo, and you can take it back.';
