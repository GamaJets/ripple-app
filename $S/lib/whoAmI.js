...
exports.WHO_AM_I_MS = void 0;
exports.shareGetUser = shareGetUser;
...
exports.WHO_AM_I_MS = sharedRead_1.SAME_LAUNCH_MS;
 ...
 * returning normally.
 */
function shareGetUser(native, isFailure, opts) {
    const shared = (0, sharedRead_1.createSharedRead)({ freshMs: opts?.freshMs ?? exports.WHO_AM_I_MS, now: opts?.now });
    return {
        async getUser(jwt) {
