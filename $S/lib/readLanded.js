...
exports.settledLanded = exports.slicesLanded = exports.sliceLanded = void 0;
/**
 ...
 */
const sliceLanded = (s) => s.state === 'ready' || s.state === 'partial';
exports.sliceLanded = sliceLanded;
/**
 ...
 * answer.
 */
const slicesLanded = (slices) => slices.every(exports.sliceLanded);
exports.slicesLanded = slicesLanded;
/**
 ...
 */
const settledLanded = (results) => results.every((r) => r.status === 'fulfilled');
exports.settledLanded = settledLanded;
