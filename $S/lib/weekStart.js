...
exports.WEEK_DAY_NAMES = exports.WEEK_DAYS = exports.WEEK_START_NAME = exports.WEEK_STARTS_ON = void 0;
exports.dayIndexInWeek = dayIndexInWeek;
exports.jsDayForIndex = jsDayForIndex;
exports.weekIndexOf = weekIndexOf;
exports.utcWeekIndexOf = utcWeekIndexOf;
exports.startOfWeek = startOfWeek;
exports.startOfWeekUTC = startOfWeekUTC;
exports.isoDay = isoDay;
exports.weekStartIso = weekStartIso;
/**
 ...
 * the header.
 */
exports.WEEK_STARTS_ON = 0;
/** The start day's own name, for copy that has to say it out loud. */
exports.WEEK_START_NAME = 'Sunday';
/** Day names in `Date.getDay()` order, which is what indexes them. */
const NAMES_BY_JS_DAY = ['Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'];
const ABBR_BY_JS_DAY = ['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'];
/**
 ...
 */
function dayIndexInWeek(jsDay) {
    return ((jsDay - exports.WEEK_STARTS_ON) % 7 + 7) % 7;
}
/** The inverse: the `getDay()` value sitting at column `index`. */
function jsDayForIndex(index) {
    return ((index + exports.WEEK_STARTS_ON) % 7 + 7) % 7;
}
/** The seven day labels in the order a week is drawn. */
exports.WEEK_DAYS = Array.from({ length: 7 }, (_, i) => ABBR_BY_JS_DAY[jsDayForIndex(i)]);
/** The same seven, written out — for a picker or a sentence. */
exports.WEEK_DAY_NAMES = Array.from({ length: 7 }, (_, i) => NAMES_BY_JS_DAY[jsDayForIndex(i)]);
/**
 ...
 */
function startOfWeek(d = Date.now()) {
...
function startOfWeekUTC(d = Date.now()) {
...
function weekStartIso(at = Date.now()) {
