...
exports.editSheetTitle = void 0;
exports.injuryPatch = injuryPatch;
exports.editResetsAck = editResetsAck;
exports.editAckWarning = editAckWarning;
exports.deleteInjuryConfirm = deleteInjuryConfirm;
 ...
 */
function editResetsAck(before, edit) {
    return (0, injuryGate_1.injuryKey)(before) !== (0, injuryGate_1.injuryKey)({ area: edit.area, severity: edit.severity });
}
/**
 ...
 */
function editAckWarning(before, edit) {
    if (before.status !== 'active')
        return null;
    if (!editResetsAck(before, edit))
        return null;
 ...
 */
function deleteInjuryConfirm(injury) {
    const what = (0, injuries_1.areaLabel)(injury.area).toLowerCase();
...
const editSheetTitle = (editing) => (editing ? 'Edit This Injury' : 'Disclose an Injury');
exports.editSheetTitle = editSheetTitle;
