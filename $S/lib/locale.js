...
exports.isWellFormedLocale = isWellFormedLocale;
exports.normaliseLocale = normaliseLocale;
exports.resolveLocale = resolveLocale;
exports.localeNote = localeNote;
exports.setAppLocale = setAppLocale;
exports.appLocale = appLocale;
exports.localeSource = localeSource;
exports.prefers12Hour = prefers12Hour;
 ...
 */
function isWellFormedLocale(tag) {
    if (!tag)
        return false;
 ...
 */
function resolveLocale(device) {
    const d = normaliseLocale(device);
    if (isWellFormedLocale(d))
        return { locale: d, source: 'device' };
    return { locale: exports.FALLBACK_LOCALE, source: 'fallback' };
}
/**
 ...
 */
function setAppLocale(device = deviceLocale()) {
 ...
 */
function prefers12Hour(locale = appLocale()) {
    try {
        ...
        const r = new Intl.DateTimeFormat(locale, { hour: 'numeric' }).resolvedOptions();
        if (typeof r.hour12 === 'boolean')
            return r.hour12;
